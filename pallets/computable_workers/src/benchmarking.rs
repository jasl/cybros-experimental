//! Benchmarking setup for pallet-computable_workers
...
mod benchmarks {
	use super::*;
	#[cfg(test)]
	use crate::pallet::Pallet as ComputableWorkers;
	...
	impl_benchmark_test_suite!(ComputableWorkers, crate::mock::new_test_ext(), crate::mock::Test);
}
