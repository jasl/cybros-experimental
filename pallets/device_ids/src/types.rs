...
//! This module contains various basic types and data structures used in the Device IDs pallet.
...
/// Mint type. Can the Device ID be created by anyone, or only the creator of the collection,
/// or only by wallets that already hold a Device ID from a certain collection?
/// The ownership of a privately minted Device ID is still publicly visible.
