...
The Device Ids pallet provides functionality for non-fungible tokens' management, including:

* Collection Creation
* Device ID Minting
* Device ID Transfers and Atomic Swaps
* Device ID Trading methods
* Attributes Management
* Device ID Burning

To use it in your runtime, you need to implement
[`device_ids::Config`](https://paritytech.github.io/substrate/master/pallet_nfts/pallet/trait.Config.html).

The supported dispatchable functions are documented in the
[`device_ids::Call`](https://paritytech.github.io/substrate/master/pallet_nfts/pallet/enum.Call.html) enum.

### Terminology

* **Collection creation:** The creation of a new collection.
* **Device ID minting:** The action of creating a new item within a collection.
* **Device ID transfer:** The action of sending an item from one account to another.
* **Atomic swap:** The action of exchanging items between accounts without needing a 3rd party service.
* **Device ID burning:** The destruction of an item.
...
The Device IDs pallet in Substrate is designed to make the following possible:

* Allow accounts to permissionlessly create a product collections.
