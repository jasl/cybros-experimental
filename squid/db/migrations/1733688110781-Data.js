module.exports = class Data1733688110781 {
    name = 'Data1733688110781'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "pool" ("id" character varying NOT NULL, "pool_id" integer NOT NULL, "owner_address" text NOT NULL, "impl_id" integer NOT NULL, "job_scheduler" character varying(10) NOT NULL, "create_job_enabled" boolean NOT NULL, "auto_destroy_processed_job_enabled" boolean NOT NULL, "metadata" text, "workers_count" integer NOT NULL, "online_workers_count" integer NOT NULL, "pending_jobs_count" integer NOT NULL, "processing_jobs_count" integer NOT NULL, "processed_jobs_count" integer NOT NULL, "successful_jobs_count" integer NOT NULL, "failed_jobs_count" integer NOT NULL, "errored_jobs_count" integer NOT NULL, "panicky_jobs_count" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "deleted_at" TIMESTAMP WITH TIME ZONE, "ref_owner_id" character varying, "ref_impl_id" character varying, CONSTRAINT "PK_db1bfe411e1516c01120b85f8fe" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "impl" ("id" character varying NOT NULL, "impl_id" integer NOT NULL, "owner_address" text NOT NULL, "attestation_method" character varying(6) NOT NULL, "metadata" text, "online_workers_count" integer NOT NULL, "pools_count" integer NOT NULL, "jobs_count" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "deleted_at" TIMESTAMP WITH TIME ZONE, "ref_owner_id" character varying, CONSTRAINT "PK_a8cc1327d4d3bff68326b317e75" PRIMARY KEY ("id"))`)
