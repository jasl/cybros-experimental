...
export type JobScheduler = JobScheduler_Dispatcher | JobScheduler_Preemption

export interface JobScheduler_Dispatcher {
    __kind: 'Dispatcher'
}

export interface JobScheduler_Preemption {
    __kind: 'Preemption'
}
